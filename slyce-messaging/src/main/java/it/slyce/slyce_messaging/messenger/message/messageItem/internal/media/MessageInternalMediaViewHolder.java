 ...
 */
public class MessageInternalMediaViewHolder extends MessageMediaViewHolder {

    public MessageInternalMediaViewHolder(View itemView, CustomSettings customSettings) {
